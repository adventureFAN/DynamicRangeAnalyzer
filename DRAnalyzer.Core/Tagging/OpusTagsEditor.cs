...
public static class OpusTagsEditor
{
        ...
        int? albumDynamicRange)
    {
        ...
        foreach (var comment in parsed.Comments)
        {
            ...
            // Alles Fremde wird bytegenau übernommen.
    ...
    private static ParsedOpusTags Parse(
        byte[] packet)
    {
        if (!packet
                .AsSpan()
        ...
        byte[] trailingData)
    {
        ...
        // Auch unbekannte/potentiell binäre Zusatzdaten
        // hinter den Comments werden vollständig erhalten.
