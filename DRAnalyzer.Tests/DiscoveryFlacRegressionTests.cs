...
public sealed class DiscoveryFlacRegressionTests
{
    ...
    [Fact]
    public void FlacReferenceAlbum_MatchesFooDrMeter108()
    {
        var albumDirectory =
        ...
        Assert.False(
            ...
            "DRANALYZER_REFERENCE_DISCOVERY_FLAC_DIR ist nicht gesetzt.");

        Assert.True(
            Directory.Exists(albumDirectory),
            $"Discovery-FLAC-Referenzordner fehlt: {albumDirectory}");
